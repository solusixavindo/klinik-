...
export const dashboardMenuGroups: DashboardMenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/pelayanan/antrian-poli", label: "Antrian Poli", icon: "◌", description: "Pantau antrean poli", requiredFeature: "queue_management" },
      { href: "/pelayanan/antrian-loket", label: "Antrian Loket", icon: "◇", description: "Pantau antrean loket pendaftaran", requiredFeature: "queue_management" },
      { href: "/pelayanan/antrian-apotek", label: "Antrian Apotek", icon: "▣", description: "Pantau antrean apotek", requiredFeature: "queue_management" },
