...
export const PLANS: Record<PlanCode, Plan> = {
  ...
  basic: {
    ...
    monthlyPrice: 249000,
    description: "Starter Klinik yang cocok untuk klinik baru mulai digitalisasi.",
    features: [
      "Data pasien",
      "Jadwal dokter",
      "Booking sederhana",
  ...
  standard: {
    ...
    monthlyPrice: 499000,
    description: "Operasional Klinik untuk sistem yang lebih rapi dan terstruktur.",
    features: [
      "Semua fitur Basic",
      "Pendaftaran pasien BPJS sederhana",
      "Antrian pasien",
      "Rekam medis digital",
      "Booking online",
      "Multi user (staff)",
  ...
  pro: {
    ...
    features: [
      ...
      "BPJS lengkap & bridging",
      "Sistem kasir & pemasukan",
  ...
  premium: {
    ...
    description: "Klinik Growth / Multi Cabang untuk scale dan profesionalisasi.",
    features: [
      "Semua fitur Pro",
